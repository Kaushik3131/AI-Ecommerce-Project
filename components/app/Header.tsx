...
import { Armchair, Package, ShoppingBag, Sparkles, User } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/80 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center gap-2">
          <Armchair className="h-6 w-6 text-amber-600 dark:text-amber-500" />
          <span className="hidden text-xl font-bold text-zinc-900 dark:text-zinc-100 sm:inline">
            The Furniture Store
          </span>
        </Link>
